...
- **Deployment:** Single machine — nginx reverse proxy + PM2/systemd process manager
...
| Phase 2 | ✅ Complete | Single-machine deployment (nginx + PM2) |
| Phase 3 | 🔴 Not started | Bitbucket Pipelines CI + build-installer |
